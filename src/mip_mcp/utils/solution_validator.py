...
class SolutionValidator:
    ...
    def validate_solution(
        self, pulp_problem: Any, solution: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Solution validation completed: {total_violations} violations found"
            )
    ...
    def _check_linear_constraints(
        self, problem: Any, variable_values: dict[str, float]
    ) -> list[dict[str, Any]]:
        ...
        try:
            ...
            for constraint_name, constraint in constraints.items():
                try:
                    ...
                    rhs_value = (
                        constraint.constant if hasattr(constraint, "constant") else 0.0
                    )
    ...
    def _check_constraint_satisfaction(
        self, lhs_value: float, sense: Any, rhs_value: float, constraint_name: str
    ) -> dict[str, Any] | None:
