...
class TestSolutionModels:
    ...
    def test_validation_violation(self):
        ...
        violation = ValidationViolation(
            type="constraint", description="Constraint c1 violated", severity="error"
        )
    ...
    def test_solution_validation(self):
        ...
        validation = SolutionValidation(is_valid=True, tolerance_used=1e-6)
    ...
    def test_optimization_solution_basic(self):
        ...
        solution = OptimizationSolution(
            status="optimal", objective_value=100.0, variables={"x": 5.0, "y": 10.0}
        )
...
class TestResponseModels:
    ...
    def test_solver_info_basic(self):
        ...
        info = SolverInfo(name="TestSolver", available=True, version="1.0.0")
    ...
    def test_solver_info_unavailable(self):
        ...
        info = SolverInfo(
            name="UnavailableSolver", available=False, error="Solver not found"
        )
